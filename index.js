...
function validateStr() {
    var inputStr = document.getElementById('inputStr').value.trim(); // Get and trim input
    if (inputStr === "") { // Check if input is empty
...
function reversestring() {
    ...
    for (var i = inputStr.length - 1; i >= 0; i--) {
        reverse += inputStr[i]; // Reverse the string
    }
    
    document.getElementById('result1').textContent = "Reversed String is " + reverse;
}
